...
public class ShowImageDialog extends Dialog {
    ...
    public ShowImageDialog(@NonNull Context context, String path, String name, String location) {
        super(context,R.style.Dialog_Msg);
        this.name = name;
        this.location = location;
        setCancelable(false);
        setCanceledOnTouchOutside(false);
        View inflate = LayoutInflater.from(context).inflate(R.layout.dialog_show_image, null);
    ...
    public void sendFace(File file) throws FileNotFoundException {
        ...
        client.post(ProjectStatic.SERVICE_PATH + "document/saveImage", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                NetUtil.getNetData("record/doRecord",map,new Handler(msg -> {
